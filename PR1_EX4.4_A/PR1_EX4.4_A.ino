...
void setup()              // run once, when the sketch starts
{
  ...
  {
    Serial.print("Qualificació Energetica Tipus F");     // Si el valor de KgCO2/m2 és inferior a 43,2 escriurà "Qualificació Energetica Tipus F"
  } 
else 
  {
    Serial.print("Qualificació Energetica Tipus G");     // Si el valor de KgCO2/m2 és superior a 43,2 escriurà "Qualificació Energetica Tipus G"
  } 
